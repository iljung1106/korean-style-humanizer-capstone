#!/usr/bin/env python3
"""Stage 6B alternating mixed generate/rewrite GRPO trainer for pipeline_v2."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train pipeline_v2 Stage 6B mixed alternating GRPO.")
    add_common_grpo_args(parser, task="mixed", default_output_name="stage06b_grpo_mixed_alternating")
    parser.set_defaults(
        ...
        rewrite_edit_weight=0.45,
        rewrite_improvement_weight=0.45,
        rewrite_improvement_scale=0.30,
        rewrite_low_edit_penalty_max=0.12,
        rewrite_edit_gate_min=0.35,
        rewrite_edit_gate_q25=0.65,
        ...
        group_diversity_bonus_max=0.035,
...
def main() -> None:
    run_grpo_stage(parse_args(), stage="stage06b_grpo_mixed_alternating", task="mixed")
